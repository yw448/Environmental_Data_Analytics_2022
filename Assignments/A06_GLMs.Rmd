...
#5
ex5= ggplot(ex4,aes(x=depth,y=temperature_C))+geom_point()+geom_smooth(method = "lm")+ylim(0,35)+labs(x="Depth",y="Temperature")
print(ex5)
```
...
```{r scatterplot.2}
#14.
ex14= ggplot(ex4, aes(x=depth, y=temperature_C, color= lakename))+geom_point(alpha=0.5)+geom_smooth(method="lm",se = FALSE)+ylim(0,35)+labs(x="Depth",y="Temperature")
print(ex14)
```
